...
Welcome to `MagicSettings` contributor's guide.
...
If you experience bugs or general issues with `MagicSettings`, please have a look
...
You can help improve `MagicSettings` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`MagicSettings` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `MagicSettings`'s files. While this mechanism can
...
```
conda create -n MagicSettings python=3 six virtualenv pytest pytest-cov
conda activate MagicSettings
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/MagicSettings.git
   cd MagicSettings
   ```
...
5. Install [pre-commit]:
   ...
   `MagicSettings` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/MagicSettings
[issue tracker]: https://github.com/<USERNAME>/MagicSettings/issues
